...
test("the pinned 2.2 surface is generated from the artifact, not from source", () => {
  assert.equal(canonical.verifiedAgainst, "2.2.0");
  assert.equal(canonical.generator, "tools/api-surface/extract-api.mjs");
  assert.ok(
    canonical.generatedFrom.includes("io.github.demchaav:graph-compose-core:2.2.0"),
    "the core artifact is where the authoring classes live",
  );
});
