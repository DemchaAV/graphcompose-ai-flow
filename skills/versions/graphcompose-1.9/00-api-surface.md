...
generatedFrom: "git tag v1.9.0 (io.github.demchaav:graph-compose:1.9.0)"
...
**GraphCompose version:** 1.9.0

Types: 199 · methods: 1571 · constants: 197
...
- `DocumentSession metadata(PdfMetadataOptions options)`
- `DocumentSession watermark(DocumentWatermark watermark)`
- `DocumentSession watermark(PdfWatermarkOptions options)`
- `DocumentSession protect(DocumentProtection protection)`
- `DocumentSession protect(PdfProtectionOptions options)`
- `DocumentSession header(DocumentHeaderFooter header)`
- `DocumentSession header(PdfHeaderFooterOptions options)`
- `DocumentSession footer(DocumentHeaderFooter footer)`
- `DocumentSession footer(PdfHeaderFooterOptions options)`
...
- `new SlotMap()`
- `SlotMap empty()`
- `SlotMap add(String slot, DocumentNode node)`
- `SlotMap addAll(String slot, List<DocumentNode> nodes)`
- `List<DocumentNode> get(String slot)`
- `List<String> populatedSlots()`
- `boolean isEmpty()`

### WeeklyScheduleTemplate (interface)


## com.demcha.compose.document.templates.builtins

### InvoiceTemplateV1 (class)
- `new InvoiceTemplateV1()`
- `String getTemplateId()`
- `String getTemplateName()`
- `String getDescription()`
- `void compose(DocumentSession document, InvoiceDocumentSpec spec)`

### InvoiceTemplateV2 (class)
- `new InvoiceTemplateV2()`
- `new InvoiceTemplateV2(BusinessTheme theme)`
- `String getTemplateId()`
- `String getTemplateName()`
- `String getDescription()`
- `void compose(DocumentSession document, InvoiceDocumentSpec spec)`

### ProposalTemplateV1 (class)
- `new ProposalTemplateV1()`
- `String getTemplateId()`
- `String getTemplateName()`
- `String getDescription()`
- `void compose(DocumentSession document, ProposalDocumentSpec spec)`

### ProposalTemplateV2 (class)
- `new ProposalTemplateV2()`
- `new ProposalTemplateV2(BusinessTheme theme)`
- `String getTemplateId()`
- `String getTemplateName()`
- `String getDescription()`
- `void compose(DocumentSession document, ProposalDocumentSpec spec)`

### WeeklyScheduleTemplateV1 (class)
- `new WeeklyScheduleTemplateV1()`
- `new WeeklyScheduleTemplateV1(WeeklyScheduleTheme theme)`
- `String getTemplateId()`
- `String getTemplateName()`
- `String getDescription()`
...
## com.demcha.compose.document.templates.data.common

### EmailYaml (class)
- `new EmailYaml()`
- `Builder builder()`
- `EmailYaml mailto(String to)`
- `EmailYaml mailto(String to, String displayText)`
...
- `Builder email(EmailYaml email)`
- `Builder email(String to, String displayText)`
- `Builder gitHub(LinkYml gitHub)`
- `Builder gitHub(String url, String displayText)`
- `Builder linkedIn(LinkYml linkedIn)`
- `Builder linkedIn(String url, String displayText)`
- `Header build()`

### LinkYml (class)
- `new LinkYml()`
- `Builder builder()`
- `LinkYml of(String url, String displayText)`
- `Builder linkUrl(LinkUrl linkUrl)`
- `Builder url(String url)`
- `Builder displayText(String displayText)`
- `LinkYml build()`


## com.demcha.compose.document.templates.data.coverletter

### CoverLetterDocumentSpec (record)
- `CoverLetterDocumentSpec of(Header header, String body, JobDetails jobDetails)`
- `Builder builder()`
- `Builder header(Header header)`
- `Builder header(Consumer<Header.Builder> spec)`
- `Builder body(String body)`
- `Builder letter(String body)`
- `Builder jobDetails(JobDetails jobDetails)`
- `Builder job(Consumer<JobDetails.Builder> spec)`
- `CoverLetterDocumentSpec build()`
...
- `Builder seniorityLevel(String seniorityLevel)`
- `Builder employmentType(String employmentType)`
- `JobDetails build()`


## com.demcha.compose.document.templates.data.cv

### CvDocumentSpec (record)
- `CvDocumentSpec of(Header header, CvModule... modules)`
- `Builder builder()`
- `Builder header(Header header)`
- `Builder addModule(CvModule module)`
- `Builder modules(CvModule... modules)`
- `Builder module(String title, Consumer<CvModule.Builder> spec)`
- `Builder paragraph(String title, String text)`
- `Builder bullets(String title, List<String> items)`
- `Builder bullets(String title, String... items)`
- `Builder dashList(String title, List<String> items)`
- `Builder dashList(String title, String... items)`
- `Builder rows(String title, List<String> rows)`
- `Builder rows(String title, String... rows)`
- `Builder summary(String text)`
- `Builder technicalSkills(List<String> items)`
- `Builder technicalSkills(String... items)`
- `Builder projects(String... rows)`
- `Builder experience(String... rows)`
- `Builder education(String... rows)`
- `Builder additional(String... rows)`
- `CvDocumentSpec build()`

### CvModule (record)
- `CvModule paragraph(String title, String text)`
- `CvModule list(String title, List<String> items)`
- `CvModule list(String title, String... items)`
- `CvModule rows(String title, List<String> rows)`
- `CvModule rows(String title, String... rows)`
...
- `Builder paragraph(String text, String firstLineIndent)`
- `Builder list(List<String> items)`
- `Builder list(List<String> items, Consumer<ListBlockBuilder> spec)`
- `Builder list(String... items)`
- `Builder rows(List<String> rows)`
- `Builder rows(String... rows)`
- `Builder table(TemplateTableSpec table)`
- `Builder divider(TemplateDividerSpec divider)`
- `Builder pageBreak(String name)`
- `Builder custom(Consumer<TemplateComposeTarget> renderer)`
- `CvModule build()`
- `ListBlockBuilder()`
- `ListBlockBuilder name(String name)`
- `ListBlockBuilder items(List<String> items)`
- `ListBlockBuilder items(String... items)`
- `ListBlockBuilder addItem(String item)`
- `ListBlockBuilder marker(ListMarker marker)`
- `ListBlockBuilder marker(String marker)`
- `ListBlockBuilder bullet()`
- `ListBlockBuilder dash()`
- `ListBlockBuilder noMarker()`
- `ListBlockBuilder continuationIndent(String continuationIndent)`
- `ListBlockBuilder normalizeMarkers(boolean normalizeMarkers)`
...
### WeeklyScheduleTheme (record)
- `TextStyle titleStyle()`
- `TextStyle weekLabelStyle()`
- `TextStyle dayLabelStyle()`
- `TextStyle noteStyle()`
- `TextStyle metricStyle()`
- `TextStyle personNameStyle()`
- `TextStyle cellTextStyle(Color textColor)`
- `TextStyle categoryLabelStyle(Color textColor)`
- `TextStyle footerStyle()`
- `WeeklyScheduleTheme defaultTheme()`


## com.demcha.compose.document.theme

### BusinessTheme (record)
...
- `BusinessTheme withPageBackground(DocumentColor color)`
- `BusinessTheme withName(String name)`

### DocumentPalette (record)
- `Builder builder()`
- `DocumentPalette of(Color primary, Color accent, Color surface, Color surfaceMuted, Color textPrimary, Color textMuted, Color rule)`
- `Builder primary(DocumentColor color)`
- `Builder primary(Color color)`
- `Builder accent(DocumentColor color)`
- `Builder accent(Color color)`
- `Builder surface(DocumentColor color)`
- `Builder surface(Color color)`
- `Builder surfaceMuted(DocumentColor color)`
- `Builder surfaceMuted(Color color)`
- `Builder textPrimary(DocumentColor color)`
- `Builder textPrimary(Color color)`
- `Builder textMuted(DocumentColor color)`
- `Builder textMuted(Color color)`
- `Builder rule(DocumentColor color)`
- `Builder rule(Color color)`
- `DocumentPalette build()`

### SpacingScale (record)
- `SpacingScale defaultScale()`
- `DocumentInsets insetsXs()`
- `DocumentInsets insetsSm()`
- `DocumentInsets insetsMd()`
- `DocumentInsets insetsLg()`
- `DocumentInsets insetsXl()`
...
- `int hashCode()`
- constants: `TIMES_ROMAN`, `HELVETICA`, `HELVETICA_BOLD`, `HELVETICA_OBLIQUE`, `HELVETICA_BOLD_OBLIQUE`, `COURIER`, `COURIER_BOLD`, `COURIER_OBLIQUE`, `COURIER_BOLD_OBLIQUE`, `TIMES_BOLD`, `TIMES_ITALIC`, `TIMES_BOLD_ITALIC`, `SYMBOL`, `DEFAULT`, `ZAPF_DINGBATS`, `LATO`, `PT_SANS`, `PT_SERIF`, `FIRA_SANS`, `UBUNTU`, `ALEGREYA_SANS`, `CARLITO`, `POPPINS`, `BARLOW`, `BARLOW_CONDENSED`, `ASAP_CONDENSED`, `ARSENAL`, `IBM_PLEX_SERIF`, `IBM_PLEX_MONO`, `CRIMSON_TEXT`, `SPECTRAL`, `ZILLA_SLAB`, `GENTIUM_PLUS`, `TINOS`, `COUSINE`, `FIRA_SANS_CONDENSED`, `KANIT`, `VOLKHOV`, `TAVIRAJ`, `TRIRONG`, `SARABUN`, `PROMPT`, `ANDIKA`, `BAI_JAMJUREE`, `JETBRAINS_MONO`
