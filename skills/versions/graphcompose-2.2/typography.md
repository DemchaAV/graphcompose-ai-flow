...
registration APIs must match the verified 2.2.0 examples — do not
invent them.
...
exact overloads against the allow-list and the 2.2.0 Javadoc before relying on a
signature.
...
- Non-Latin scripts may require explicit font selection that the
  ...
  and verify against the 2.2.0 examples before promising parity.
