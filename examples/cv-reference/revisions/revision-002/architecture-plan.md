...
| Horizontal divider | Full-bleed `LineBuilder` with page-width measure |
...
| Skills | `SectionBuilder` labels + horizontal `LineBuilder` rules plus vertical marker `LineBuilder` dividers |
