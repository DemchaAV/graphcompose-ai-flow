...
public final class GeneratedCvTemplate {
    ...
    public void compose(DocumentSession document) {
        ...
        document.pageFlow(page -> page
                ...
                .addLine(line -> line
                        ...
                        .thickness(6)
                        .color(ACCENT)
                        .margin(new DocumentInsets(18, -52, 28, -52)))
    ...
    private void renderSkills(SectionBuilder section) {
        ...
        skill(section, "S O C I A L  M E D I A", "-----------------|---");
        skill(section, "A D O B E  S U I T E", "------------------|--");
        skill(section, "M I C R O S O F T  W O R D", "---------------|-----");
        skill(section, "H T M L / C S S", "--------------|------");
        skill(section, "W O R D P R E S S", "-------------------|-");
    }
    ...
    private void skill(SectionBuilder section, String name, String rule) {
        label(section, name);
        section.addParagraph(p -> p
                .text(rule)
                .textStyle(style(8.0, RULE, DocumentTextDecoration.DEFAULT))
