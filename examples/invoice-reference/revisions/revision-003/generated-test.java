...
/**
 * Smoke test for the revision-003 {@link GeneratedInvoiceTemplate}.
 *
 ...
 * </ul>
 *
 * <p>The revision-003 patch adds root page padding so the rendered
 * invoice no longer starts flush against the page's top-left edge. Until
 * a real reference image is available this test only enforces the
 * compose-does-not-throw smoke contract; the visual change is exercised
 * by the committed {@code output.png} and the visual review.</p>
 */
