...
/**
 * Revision-004 of the Noir Corporate CV template.
 *
...
public final class GeneratedCvTemplate {
    ...
    private static final double CV_TEXT_OVERLAY_TOP = -CV_DIAMETER * 0.66;
    private static final double CV_TEXT_OVERLAY_BOTTOM = 110.0;
    ...
    private void renderNameBar(SectionBuilder section, NoirCorporateCvSpec spec) {
        section.fillColor(DARK)
                .padding(new DocumentInsets(86.0, MAIN_PAD_X, 82.0, MAIN_PAD_X))
                .spacing(4)
                .addParagraph(p -> p
