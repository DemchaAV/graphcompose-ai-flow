...
/**
 * Revision-002 of the Noir Corporate CV template.
 *
 ...
 * name bar, the dark section heading bars, the circular CV badge, shape-based
 * rating dots, and marker rows for work-experience entries. The renderer is
...
public final class GeneratedCvTemplate {
    ...
    private void ratingRow(SectionBuilder section, String name, double level) {
        section.addParagraph(p -> p
                .inlineText(name, labelStyle(), null)
                .inlineText("     " + dotMeter(level),
                        style(5.7, BLACK, DocumentTextDecoration.DEFAULT),
                        null)
                .margin(new DocumentInsets(0, 0, 6, 0)));
    }
    ...
    private static String dotMeter(double level) {
